...
class ApiInvoker(formats: Formats)(implicit system: ActorSystem) extends CustomContentTypes with Json4sSupport {
  import it.pagopa.interop.selfcare.partyprocess.client.invoker.ApiInvoker._
  import it.pagopa.interop.selfcare.partyprocess.client.invoker.ParametersMap._
