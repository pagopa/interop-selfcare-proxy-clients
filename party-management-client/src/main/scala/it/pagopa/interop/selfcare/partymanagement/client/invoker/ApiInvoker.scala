...
class ApiInvoker(formats: Formats)(implicit system: ActorSystem) extends CustomContentTypes with Json4sSupport {
  import it.pagopa.interop.selfcare.partymanagement.client.invoker.ApiInvoker._
  import it.pagopa.interop.selfcare.partymanagement.client.invoker.ParametersMap._
